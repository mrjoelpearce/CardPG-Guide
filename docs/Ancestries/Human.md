...
| ----------- | ----- | ---------- | ----------------------------------------------- |
| Surge       | 1     | 25         | Expend: Attack 4. Recover 1 random exiled card. |
| Momentum    | 1     | 30         | Attack 2, then move 2 spaces.                   |
| Persistence | 5     | 22         | Move 2 and Attack 1. Then repeat.               |
| Reposition  | 5     | 28         | Attack 3, then move 2 spaces.                   |