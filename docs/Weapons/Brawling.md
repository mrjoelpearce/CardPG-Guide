Brawling is for characters who don't use weapons, or would rather use weapons they find in the environment. Hit fast and often.

Passive: Your second and subsequent attacks each turn deal 1 additional damage.
...
| Rampage           | 9     | 38         | Expend: Move 2, then Attack 4 against every adjacent enemy. Gain Retaliate 4.        |