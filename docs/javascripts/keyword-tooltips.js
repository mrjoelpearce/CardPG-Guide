...
(function () {
  const KEYWORDS = {
    ...
    Hide: "You cannot be targeted except by AOE effects. Lasts until you make an attack or target an enemy — clears the moment you do, however many rounds that takes.",
